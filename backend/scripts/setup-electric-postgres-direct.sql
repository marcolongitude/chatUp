-- Script SQL para executar DIRETAMENTE no psql do Railway
-- Execute: railway connect --service postgres
-- Depois copie e cole este conteúdo no prompt psql
...
-- Se as tabelas ainda não existem, execute apenas após TypeORM criar
DO $$
BEGIN
